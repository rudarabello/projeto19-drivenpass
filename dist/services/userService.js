        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    checkUser = _a.sent();
                    if (checkUser)
                        throw checkError(401, "This email is already registered!");
                    return [4 /*yield*/, register(email, encrypt(password))];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    if (!user)
                        throw checkError(404, "There's no user registered with this email!");
                    return [4 /*yield*/, verifyPassword(password, user.password)];
                case 2:
                    if (_a.sent())
                        throw checkError(401, "Wrong password!");
                    token = generateUserToken(user.id);
                    userInfo = {
                        userId: user.id,
                        token: token
                    };
                    return [4 /*yield*/, newSession(userInfo)];
                case 3:
                    _a.sent();
